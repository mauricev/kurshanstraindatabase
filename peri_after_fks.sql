...
--
-- Host: localhost    Database: k-empty1
-- ------------------------------------------------------
...
CREATE TABLE `plasmid_table` (
  ...
  `comments_col` varchar(768) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sequence_data_col` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
...
CREATE TABLE `strain_to_transgene_table` (
  ...
  KEY `transgene_constraint` (`transgene_fk`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-08-12 12:36:28
