...
<html lang="en" dir="ltr">
  ...
  <body>
    <?php
      ...
      if (isset($_POST['handedOffState_buttonValue'])) {
          $theNewHandedOffState = $_POST['handedOffState_buttonValue'];
      } else {
        // BUGFixed wrong variable here
      ...
      if(isset($_POST['highValueStrainArray_htmlName'])){
        $selectedHighValueReason = $_POST['highValueStrainArray_htmlName'];
        if ($selectedHighValueReason[0] == "") {
          $selectedHighValueReason[0] = NULL;
        }
      } else $selectedContributor[0] = NULL;
      ...
      //BUGFixed, was not declared for new strains, 2024-04-25
      ...
      if ($isStrainBeingEdited) {
        ...
        if(($theNewHandedOffState) && ($theNewHandedOffState != $theOriginalHandedOffState)) {
          $theNewHandedOffDate = date("Y-m-d");
          $strainHasBeenChanged = true;
        }


        // high value strain reason
        if ($_POST['originalHighValueReason_postvar'] != $selectedHighValueReason[0]) {
          $strainHasBeenChanged = true;
        }
