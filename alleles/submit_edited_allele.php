    ...
    <?php
      ...
      if (!$isEntityBeingEdited) {
        ...
        if ($_POST["manufacturedWhere_htmlName"] == "externally-sourced") {
          ...
          $newAlleleObject = new Allele($theAlleleName, $theNewComment,$theNewSelectedGene[0],$theSequenceFileName,$theSequenceFileData,$theSequenceFieldsShouldBeUpdated);
        ...
        switch ($switchedState) {
          // if we are go to a “to” state, then we are submitting the allele for an update regardless
            ...
            $newAlleleObject= new Allele($theNewAlleleName, $theNewComment,$theNewSelectedGene[0],$theSequenceFileName,$theSequenceFileData,$theSequenceFieldsShouldBeUpdated);
        		if(!$newAlleleObject->doesItAlreadyExist()){
          ...
          case "toLabProduced":
            ...
            // new method updateOurEntryWithCounterTableUpdate creates a new counter record but keeps the allele into the existing record
	            $newAlleleObject = new Allele("", $theNewComment,$theNewSelectedGene[0],$theSequenceFileName,$theSequenceFileData,$theSequenceFieldsShouldBeUpdated);
            // updates sequence data automatically
          ...
          case "stayingOnLabProduced":
            ...
            $newAlleleObject = new Allele($theOriginalAlleleName, $theNewComment,$theNewSelectedGene[0],$theSequenceFileName,$theSequenceFileData,$theSequenceFieldsShouldBeUpdated);
            // updates sequence data automatically
            $newAlleleObject->updateOurEntry($theOldAlleleID);
            ourheader("location: ../start/start.php");
            break;
